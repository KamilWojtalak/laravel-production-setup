<x-public-layout>
    ...
    <section class="public-section">
        <div class="container">
            <h2>SUKCES PAGE - SUBSCRIPTION</h2>
        </div>
        ...
        <form action="{{ route('stripe.subscription.create-portal-session') }}" method="POST">
            @csrf
            <input type="hidden" id="session-id" name="session_id" value="{{ request()->get('session_id') }}" />
